...
5. Проверить, чтобы в параметрах программы стояло "Подключение кассы" - "Стандартно" ![Подключение кассы стандартно](media/подключение_кассы_стандартно.png) подключение_кассы_стандартно
