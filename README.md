...
- поддерживает **[ставку НДС 22%](docs/instruction.md#поддержка-ндс-22)**
- поддерживает новый механизм работы [проверки маркировки **ТС ПИоТ**](docs/marking.md#разрешительный-режим-тс-пиот)
- 
## Навигация ##
