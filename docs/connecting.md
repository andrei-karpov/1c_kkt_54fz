...
Для продажи маркированных товаров настройте [ТС ПИоТ](ts_piot.md) после подключения ККТ и до первой продажи. В этой главе приведены требования к моделям, прошивкам и драйверам, порты, установка ЕСМ и настройка обработки версии 4.17 или выше.
