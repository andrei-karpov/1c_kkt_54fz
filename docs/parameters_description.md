...
**«Касса не поддерживает НДС 5% и 7% (ждем прошивку)»** - если для кассы еще не вышли нужные драйвера для поддержки ставки НДС 5%, то включите данный флаг. Согласно рекомендациям ФНС, если касса еще не поддерживает новые ставки, то можно пока передавать ставку **без ндс**. В таком случае, обработка перед непосредственной печатью подменит новые ставки на **"без ндс"**, таким образом можно добавить поддержку новых ставок НДС, и ждать выпуска новых прошивок.

**«Автоматически перейти на новую ставку в конце года»** - временная настройка, чтобы спокойно перейти с нового года на новые ставки НДС, можно включить данный параметр. В таком случае, если выполнена доработка, или в параметрах обработки указано заполнение новыми ставками НДС, то до 2025 года, если обработка будет передавать новые ставки НДС, то они автоматически будут преобразованы в ставку **"без ндс"**, а с 2025 года ставка будет передаваться, как она передана. 
