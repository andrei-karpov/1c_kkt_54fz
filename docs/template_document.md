...
Откройте параметры обработки и выберите «Шаблон документа».
![Выбор параметры настройки шаблона](media/3c1b15272f1a73f0e2a998a2f5128c26.png)

Шаблон задаёт дополнительный текст чека, данные покупателя, штрихкоды и оформление фискальных строк.
...
## Проверка изменения шаблона

Для первого изменения выберите один тип документа и добавьте простую текстовую строку, например «Спасибо за покупку». Используйте «Проверка шаблона», затем сформируйте предварительный чек по документу этого типа.

Проверьте положение строки и сохранность товаров, сумм и реквизитов. Если используются операнды, проверьте документ с заполненными значениями и документ, где нужное поле пусто. После этого сохраните шаблон. Наличие текста в предварительном просмотре не подтверждает поддержку выбранного шрифта или штрихкода конкретной ККТ.
