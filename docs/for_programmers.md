...
В данном разделе размещены примеры изменения обработки или конфигурации 1С для использования основного функционала программы.
...
Для конфигураций Рарус доработка не требуется, так как там ставка НДС - это справочник, и новую ставку может добавить просто пользователь, добавив новый элемент в справочник. Данная инструкия подойдет для конфигураций Управление производственным предприятием, Комплексная автоматизация 2, Управление торговлей 10.3, Розница 1 и т.д. 
Общая рекомендация такова - мы находим все места в коде, где применяется ставка НДС 18% или 20% (в зависимости от того, на сколько старая конфигурация) и добавляем туда код использования ставки 5% и 7%, в том числе и расчетные авансовые ставки 7_107 и 5_105. 
Для этого подготовил небольшую видео инструкцию.
