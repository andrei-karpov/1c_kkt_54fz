...
2. Использовать компоненты на оборудование, что работают на [ревизии](connecting.md#что-такое-ревизия-драйвера) 4004 или выше. На текущй момент данную ревизию поддерживают компоненты АТОЛ, ВикиПринт, Меркурий и Эмулятор торгового оборудования.
...
3. Установить актуальные драйвера, что поддреживают данную ставку, и при необходимости установить прошивку. 
   ...
   - для касс ШтрихМ установить драйвера 5.18.0.1061 [дополнительная информация](https://teletype.in/@poscenter/2025). 
