...
3. Установить актуальные драйвера, что поддреживают данную ставку, и при необходимости обновите прошивку. 
...
3. Установить актуальные драйвера, что поддреживают данную ставку, и при необходимости установить прошивку. Начиная с версии обработки 4.10, доступен [**мастер подключения**](connecting.md#мастер-подключения-компонент-начиная-с-версии-410)
