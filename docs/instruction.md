...
3. Установить актуальные драйвера, что поддреживают данную ставку, и при необходимости установить прошивку. Например, если у вас драйвера АТОЛ, то прошивка должна быть не ниже версии 5.15, и установлены дравера 10.10.6 или выше.
