...
> Изменился адрес сервера лицензирования (в связи с проблемами у хостера).  
> Для корректной работы программы рекомендуется обновить её до той же версии — внутри изменён только адрес сервера лицензирования.  
> Скачать обновление можно по ссылке:  
> [Обновление](https://disk.yandex.ru/d/VoqPUzNsOmZJaw) 
...
- Поддерживае разрешительный режим продажи маркированного товара ([Настройка разрешительного режима продажи](marking.md#разрешительный-режим-продажи-маркировки))
