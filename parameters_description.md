...
**«Отключить типовой механизм работы со сканерами»** - отключает механизм работы с торговым оборудованием, когда сканер штрихкодов уже подключен к 1С через типовой функционал, такой механизм есть в типовых конфигурациях Управление торговлей 10.3, Управление производственным предприятием 1.3, и т.д.
...
**«Адрес Магазина»** - для формата обмена ФФД 1.05 и ФФД 1.1, содержит Адрес магазина, который будет передан в ОФД, также может быть использован для печати не фискальных чеков.
