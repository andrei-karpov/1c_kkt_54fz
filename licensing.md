...
- нажмите **Получить ключ** - откроется [форма лицензирования](#форма-лицензирования) (либо через параметры - "Ручное управление" - "Лицензирование", если программа у вас уже работает);
