...
Для этого в [форме первоначальной настройки](connecting.md#Подключение)(либо через [форму лицензирования](#форма-лицензирования), если программа у вас уже работает):

- нажмите **Получить ключ**;
- откроется форма лицензирования, в ней укажите адрес электронной почты, при это "пароль" заполнять не нужно.
