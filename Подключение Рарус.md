...
- дорабатаем модуль объекта обработки "ФронтКассира":
...
- нажмите **"Настроить параметры"**, и воспользуйтесь [этой инструкцией по настройке](Подключение.md) обработки
