...
заполнение реквизитов агента в обработку:
...
заполнение реквизитов поставщика в обработку:
...
```
 ...
 [пример самой обработки](bin/Заполнение_данных_поставщика_и_агента_через_доп_обработчик.epf)
